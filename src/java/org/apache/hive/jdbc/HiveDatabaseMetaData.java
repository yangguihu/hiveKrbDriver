...
//    return getSchemas(null, null);
	  ...
	  try {
	  	...
	  	rs = st.executeQuery("select name as  from dbs");
  ...
  //==============自定义数据源================
	...
	public Connection getConn() {
		...
		String url="jdbc:mysql://172.24.5.243:3306/hive?zeroDateTimeBehavior=convertToNull&useUnicode=false&characterEncoding=UTF-8&useOldAliasMetadataBehavior=true";
